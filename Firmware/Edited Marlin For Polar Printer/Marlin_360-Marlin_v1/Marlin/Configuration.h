...
#define BAUDRATE 250000 // was 115200  
...
// In our case it is (128 / 16) * (80 / 64)  * (360 / 0.9) * 16 / 2 = 32000
#define R_360_STEPS_PER_ROTATION 32000 // was 5760
...
#define DISABLE_MAX_ENDSTOPS // was commented
#define DISABLE_MIN_ENDSTOPS // was commented
...
// NOTE!! - the E steooer per unit was 327 but in my cartesian printer it was 372, thus i changed it
// was - DEFAULT_AXIS_STEPS_PER_UNIT   {80,18,250,327}
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,18,1200,372} //e:720 wades  //(80,18,4000,327)// default steps per unit for (R-360 Y 15.9431734297273 calculated)R_360_STEPS_PER_ROTATION/(PI*2)
