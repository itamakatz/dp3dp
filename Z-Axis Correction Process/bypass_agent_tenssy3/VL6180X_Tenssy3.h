#ifndef VL6180X_Tenssy3_h
#define VL6180X_Tenssy3_h

#include <Arduino.h>

class VL6180X_Tenssy3
{
  public:
    // register addresses
    enum regAddr
    {
      ...
      RANGE_SCALER                          = 0x096, // 16-bit - see STSW-IMG003 core/inc/VL6180X_Tenssy3_def.h
